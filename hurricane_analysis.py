...
print(hurricane_by_year_dict(1940))
print(hurricane_by_year_dict(1989))
...
max_area, max_area_cnt = most_affected_area(areas_affected)
print('max_area : {0}, max_area_count : {1}'.format(max_area, max_area_cnt)  )
...
def greast_number_of_death(dict) :
  max_death = 0
  hurricane_name = ''
  ...
  for name in dict :
    if dict[name]['Deaths'] > max_death :
      ...
      hurricane_name = name
  return max_death,hurricane_name

print(greast_number_of_death(hurricanes))
...
def mortality_func(dict) :
  ...
  for name in dict  :
    ...
    elif dict[name]['Deaths'] <= mortality_scale[1] :
      hurricane_mortality[1].append(name)
    elif dict[name]['Deaths'] <= mortality_scale[2] :
      hurricane_mortality[2].append(name)
    elif dict[name]['Deaths'] <= mortality_scale[3] :
      hurricane_mortality[3].append(name)
    elif dict[name]['Deaths'] <= mortality_scale[4] :
...
print('---')
print(mortality_func(hurricanes))
...
def greatest_damage(dict) :
  ...
  greatest_damage = max(damage_list)
...
hurricanes_by_damage = {'No Damage':[],1:[],2:[],3:[],4:[],5:[]}
def categorize_by_damage(dict) :
  ...
  for name in dict :
    if dict[name]['Damage'] == 'Damages not recorded' :
      hurricanes_by_damage['No Damage'].append(name)
